...
console.log("-------------------------------------------");
console.log(
  chalk.blue(`${capatalizedName},Pehla prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Dusra prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Teesra prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Chautha prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Panchwa prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Chatha prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Sathwa prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Aathwa prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Nawwa prashn apki screen par yeh raha`)
);
...
console.log(
  chalk.blue(`${capatalizedName},Daswa prashn apki screen par yeh raha`)
);
